        ...
        function LocationAutoComplete(){
          ...
          var countries = [
            ...
            var costaRicaCities = [
              ...
              {state: 'Pérez Zeledón', name: 'San Isidro de El General' },
              {state: 'Pérez Zeledón', name: 'General' },
              {state: 'Pérez Zeledón', name: 'Daniel Flores' },
              {state: 'Pérez Zeledón', name: 'Rivas' },
              {state: 'Pérez Zeledón', name: 'San Pedro' },
              {state: 'Pérez Zeledón', name: 'Platanares' },
              {state: 'Pérez Zeledón', name: 'Pejibaye' },
              {state: 'Pérez Zeledón', name: 'Cajón' },
              {state: 'Pérez Zeledón', name: 'Barú' },
              {state: 'Pérez Zeledón', name: 'Río Nuevo' },
              {state: 'Pérez Zeledón', name: 'Páramo' },
